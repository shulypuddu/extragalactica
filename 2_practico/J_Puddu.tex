...
El Sloan Digital Sky Survey (SDSS) es uno de los catálogos más relevantes y con mayor trayectoria en el área. Utiliza un telescopio de 2.5 metros de diámetro ubicado en el Observatorio de Apache Point en Sunspot, Nuevo México, a 2788 metros sobre el nivel del mar. El survey cuenta con 19 \textit{Data Releases} (DR) y con 5 distintas etapas donde se varian los enfoques de observación y los instrumentos utilizados.

SDSS trabaja con cinco filtros: $u$, $g$, $r$, $i$, $z$. Es común caracterizar las galaxias según sus propiedades en el filtro $r$, ya que se asemeja más a la región visible del espectro electromagnético y es el que SDSS eligió como filtro principal.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{gal_in_sky.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{gal_z.png}
    \caption{Ubicación en el cielo de las galaxias seleccionadas.}
    \label{fig:hist_z}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{mag_vs_z.png}
    \caption{Ubicación en el cielo de las galaxias seleccionadas.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{mabs_vs_z.png}
    \caption{Ubicación en el cielo de las galaxias seleccionadas.}
    \label{fig:M_r_hist}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{colores.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{rojas_y_azules.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{hist_c.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{hist_fracdev.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{fracdev_vs_c.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{gr_vs_c.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{mabs_vs_r50.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{mabs_vs_r50_azulyrojo.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{mabs_vs_r50_bulgeydisco.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{mabs_vs_r50_earlyylate.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{dcm_ur.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{dcm_bd.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.65\linewidth]{dcm_el.png}
