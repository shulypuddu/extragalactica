...
plt.figure(figsize=(10,6))
plt.scatter(tempranas['petroR50_r'],tempranas['mu_sup'], s=1, color='teal', marker='.',alpha=0.75,label=r'Tempranas ($ C \neq 2.5$)')
plt.scatter(tardias['petroR50_r'],tardias['mu_sup'], s=1, color='hotpink', marker='.',alpha=0.75,label=r'Tardías ($C<2.5$)')
plt.xlabel('Radio efectivo ($r_{50}}$)', fontsize=14)
plt.ylabel('Brillo superficial ($\mu_{50}$)', fontsize=14)
plt.title('Radio efectivo vs Brillo superficial',fontsize=17)
plt.tight_layout()
...
plt.figure(figsize=(10,6))
plt.scatter(bulge['petroR50_r'],bulge['mu_sup'], s=1, color='darkorange', marker='.',alpha=0.75,label=r'Bulbo ($ FracDeV \neq 0.8$)')
plt.scatter(disco['petroR50_r'],disco['mu_sup'], s=1, color='royalblue', marker='.',alpha=0.75,label=r'Disco ($ FracDeV \leq 0.2$)')
plt.xlabel('Radio efectivo ($r_{50}}$)', fontsize=14)
plt.ylabel('Brillo superficial ($\mu_{50}$)', fontsize=14)
plt.title('Radio efectivo vs Brillo superficial',fontsize=17)
plt.tight_layout()
...
plt.plot(x1_fit, g_azul,  label='Gaussiana para mas rojas',color='dodgerblue') 
plt.plot(x2_fit, g_rojo, color='indianred', label='Gaussiana para mas azules') 
plt.xlim(0, 4)
...
fig, axs = plt.subplots(2, 1, figsize=(14, 18)) # 2 filas, 1 columna
# Primer gráfico: scatter de M_r vs z
axs[0].hist(rojo['color_g_r'], bins='auto',density=True, alpha=0.55,facecolor='indianred',edgecolor='indianred',label='rojas')
axs[0].hist(azul['color_g_r'], bins='auto',density=True, alpha=0.55,facecolor='dodgerblue',edgecolor='dodgerblue',label='azules')
...
axs[0].legend()
# Segundo gráfico: histograma de color_u_r
axs[1].hist(rojo['color_u_r'], bins='auto',density=True, alpha=0.55,facecolor='indianred',edgecolor='indianred',label='rojas')
axs[1].hist(azul['color_u_r'], bins='auto',density=True, alpha=0.55,facecolor='dodgerblue',edgecolor='dodgerblue',label='azules')
...
bulbo=bulge['c_par'].mean()
disk=disco['c_par'].mean()

plt.figure(figsize=(10,6))
plt.scatter(df['c_par'],df['fracDeV_r'], marker='.',color=bar_color,alpha=0.5)
plt.scatter(bulge['c_par'],bulge['fracDeV_r'], marker='.',color='darkorange',label=r'bulge $FracDeV \leq 0.8$',alpha=0.5)
plt.scatter(disco['c_par'],disco['fracDeV_r'], marker='.',color='royalblue',label=r'disco $FracDeV \neq 0.2$',alpha=0.5)
plt.axvline(x=2.5,color=linea_color, linestyle='--', label='C=2.5')
plt.axvline(x=bulbo,color='darkorange', linestyle='--')
plt.axvline(x=disk,color='royalblue', linestyle='--')
...
plt.figure(figsize=(10,6))
plt.scatter(df['color_u_r'],df['c_par'], marker='.',color=bar_color,label='muestra')
plt.scatter(rojo['color_u_r'],rojo['c_par'],marker='.',color='indianred',alpha=0.5,label='rojas')
plt.scatter(azul['color_u_r'],azul['c_par'],marker='.',color='dodgerblue',alpha=0.5,label='azules')
plt.ylabel('(C)')
plt.xlabel('Indice de color u-r')
plt.xlim(0,3.5)
plt.ylim(1.25,4.15)
...
plt.gca().invert_xaxis()  # Invertir eje Y (magnitud)
plt.plot()
plt.legend()
...
plt.plot()
plt.legend()
plt.savefig('/mnt/sda2/extragalactica/2_practico/imagenes/dcm_el.png', dpi=300,bbox_inches='tight')
plt.show()
...
plt.plot()
plt.legend()
plt.savefig('/mnt/sda2/extragalactica/2_practico/imagenes/dcm_bd.png', dpi=300,bbox_inches='tight')
plt.show()
...
plt.figure(figsize=(10,6))
plt.scatter(rojo['abs_model_mag_r'], rojo['petroR50_r'], s=1, color='indianred', marker='.',alpha=0.5,label='rojas')
plt.scatter(azul['abs_model_mag_r'], azul['petroR50_r'], s=1, color='dodgerblue', marker='.',alpha=0.5,label='azules')
plt.yscale('log')
plt.ylim(0.5,10)
plt.ylabel('Radio petrosiano 50$\%$')
plt.xlabel('Magnitud absoluta en r ($M_r$)')
...
plt.figure(figsize=(10,6))
plt.scatter(tempranas['abs_model_mag_r'],tempranas['petroR50_r'], s=1, color='teal', marker='.',alpha=0.5,label='tempranas')
plt.scatter(tardias['abs_model_mag_r'], tardias['petroR50_r'], s=1, color='hotpink', marker='.',alpha=0.5,label='tardias')
plt.yscale('log')
plt.ylim(0.5,10)
plt.ylabel('Radio petrosiano 50$\%$')
plt.xlabel('Magnitud absoluta en r ($M_r$)')
...
plt.figure(figsize=(10,6))
plt.scatter(bulge['abs_model_mag_r'],bulge['petroR50_r'], s=1, color='darkorange', marker='.',alpha=0.5,label='bulge')
plt.scatter(disco['abs_model_mag_r'], disco['petroR50_r'], s=1, color='royalblue', marker='.',alpha=0.5,label='disco')
plt.yscale('log')
plt.ylim(0.5,10)
plt.ylabel('Radio petrosiano 50$\%$')
plt.xlabel('Magnitud absoluta en r ($M_r$)')
