...
# installed.
TK_PREFIX='/mnt/sda2/extragalactica/extra'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/mnt/sda2/extragalactica/extra'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/mnt/sda2/extragalactica/extra/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/mnt/sda2/extragalactica/extra/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/mnt/sda2/extragalactica/extra/include'
...
# compiled.
TK_SRC_DIR='/mnt/sda2/extragalactica/extra/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/mnt/sda2/extragalactica/extra/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/mnt/sda2/extragalactica/extra/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/mnt/sda2/extragalactica/extra/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/mnt/sda2/extragalactica/extra/lib/libtkstub8.6.a'
