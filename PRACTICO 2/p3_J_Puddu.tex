...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Propiedades generales de galaxias usando el catálogo SDSS}
...
La característica más básica de cualquier objeto es su forma aparente, para una galaxia esto no es distinto, por tanto a lo largo del tiempo se han desarrollado distintos métodos para clasificar las galaxias según su forma.
...
En este trabajo se utiliza una muestra de 20000 galaxias del catálogo DR7 de SDSS \citep{SDSSDR7}, sometida a una limpieza preliminar y analizada mediante datos fotométricos y espectroscópicos.
...
El sistema Petrosiano \citep{1976ApJ...209L...1P} mide flujos de una mide flujos dentro de una apertura circular cuyo radio define la forma del perfil de luz promediado azimutalmente. La razón Petrosiana $R_P$ a radio $r$ es:
\begin{equation}
...
\begin{figure}[ht]
    ...
    \caption{Distribución del redshift de la muestra tomada.}
    \label{fig:hist_z}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Magnitud aparente en el filtro $r$ desafectada por extinción VS. redshift de la muestra.}
...
\begin{figure}[ht]
    ...
    \caption{Magnitud absolutd en el filtro $r$ VS. redshift de la muestra.}
    \label{fig:M_r_hist}
\end{figure}
...
Para separar por color se ajusto dos distribuciones gaussianas al índice u-r como se ve en la figura \ref{fig:red_blue}, ya que es donde el cambio es más marcado debido a una mayor diferencia entre las longitudes de onda de cada filtro, y se selecciono como límite el punto donde ambas gaussianas se tocan, esto es en el punto $u-r \sim 2.10$.

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{colores.png}
    \caption{Histograma de los colores $u -r$ y $g-r$ de las galaxias seleccionadas.}
    \label{fig:colores}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{colores_ajustados.png}
    \caption{Ajuste de 2 gaussianas para el histograma de la muestra del color $u-r$}
    \label{fig:red_blue}
\end{figure}

En la figura \ref{fig:red_blue} se puede ver que la gaussiana correspondiente a las ``galaxias azules'' tiene mayor amplitud y un mayor $\sigma$ que la correspondiente a las ``galaxias rojas'', esto es algo que se mantiene a lo largo de las distintas magnitudes, para esto se dividió la muestra en cuartiles de igual cantidad según los valores de $M_r$ y se ajusto la suma de gaussianas al histograma de cada cuartil, con esto se obtuvo la figura \ref{fig:dcm_quart} donde podemos ver los centros de cada gaussiana y la barra de $1\sigma$ a cada lado, estas están centradas en el valor medio de cada cuartil.


\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{diagrama_color_magnitud_dispersion.png}
    \caption{Ajuste de 2 gaussianas para el histograma de la muestra del color $u-r$, dividiendo en cuartiles según la magnitud absoluta}
    \label{fig:dcm_quart}
\end{figure}
...
De la figura \ref{fig:dcm}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{diagrama_color_magnitud_dispersion.png}
    \caption{Diagrama tamaño vs luminosidad para toda la muestra de galaxias.}
    \label{fig:mabs_vs_r50_ajustado}
\end{figure}
